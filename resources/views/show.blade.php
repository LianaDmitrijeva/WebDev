    ...
    <div class="row">
        <div class="view">
            ...
            @if (auth()->user()->usertype == 'user')
                ...
                <a style=" width:80%; margin-top:10px; margin-bottom:10px;" class="btn btn-secondary" href="{{ route('home',$post->id) }}">Go Back</a>
                @else
                <form action="{{ route('favorite.add', $post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <a style=" width:80%; margin-top:10px; margin-bottom:10px;" class="btn btn-secondary" href="{{ route('feed',$post->id) }}">Go Back</a>
                </form>
                @endif
            @else
...
<x-app-layout>
    ...
    <div class="row">
        <div class="view">
            ...
            <a style=" width:80%; margin-top:10px; margin-bottom:10px;" class="btn btn-secondary" href="{{ route('welcome',$post->id) }}">Go Back</a>
        </div>  
    </div>
</x-app-layout>
@endauth
